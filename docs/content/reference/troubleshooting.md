...
Most of these come down to network reality or how timus serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

timus rate-limits like any public site. timus already paces
...
Where a surface is gated, timus reads a cookie or token you supply
...
`timus`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what timus actually did
